  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <img
        ...
        alt="Login-bg"
      />
      <form className="w-[25%] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-black/70 p-6 rounded-xl text-white">
        ...
        <input
          ...
          required
        />
        <button className=" border-2 border-red-600 rounded-sm mx-auto block w-[85%] mt-5 mb-5 h-11 bg-red-600">
          {isSignUp ? "Sign Up" : "Sign In"}
        </button>
        <p
